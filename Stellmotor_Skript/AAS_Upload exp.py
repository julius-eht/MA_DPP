...
JSON_FILES = [
    "Input_Files/AAS_motor_example exp.json",
    "Input_Files/AAS_process_schrauben_1 exp.json",
    "Input_Files/AAS_procedure_schrauben_1 exp.json",
    "Input_Files/AAS_process_pressen_2_3 exp.json",
    "Input_Files/AAS_procedure_pressen_2_3 exp.json",
]
